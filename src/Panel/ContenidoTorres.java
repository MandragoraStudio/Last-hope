...
public class ContenidoTorres extends Contenido {
    ...
    public void cargar() throws Exception {
        ...
        coste.put("uranio", 0);
        coste.put("rodio", 30);
        coste.put("grafeno", 30);
        coste.put("radio", 0);
        coste.put("cromo", 0);
        coste.put("energia", 10);
        ...
        coste2.put("uranio", 0);
        coste2.put("rodio", 20);
        coste2.put("grafeno", 60);
        coste2.put("radio", 15);
        coste2.put("cromo", 25);
        coste2.put("energia", 20);
        ...
        coste3.put("uranio", 10);
        coste3.put("rodio", 30);
        coste3.put("grafeno", 40);
        coste3.put("radio", 30);
        coste3.put("cromo", 0);
        coste3.put("energia", 50);
        BotonCreadorTorre b3 = new BotonCreadorTorre(img3, img3, "Frio y Veneno", this.calculaX(), this.calculaY(), img1.getWidth(null), img1.getHeight(null), new Tower("Frio y Veneno", 2, 15, 150, 50, 0, 0, 20, 30, coste3, Vector2D.fuera, img3));
